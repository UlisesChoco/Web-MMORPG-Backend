...
export interface FatalCombatReplayService {
  GetFatalCombatReplay(
    request: GetFatalCombatReplayRequest,
  ): Observable<GetFatalCombatReplayResponse>;
  GetRecentFatalities(
    request: GetRecentFatalitiesRequest,
  ): Observable<GetRecentFatalitiesResponse>;
}
