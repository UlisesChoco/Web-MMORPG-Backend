...
export interface CombatHistoryService {
  GetCombatHistoryByPlayer(
    request: GetCombatHistoryByPlayerRequest,
  ): Observable<GetCombatHistoryByPlayerResponse>;
  GetRecentCombats(
    request: GetRecentCombatsRequest,
  ): Observable<GetRecentCombatsResponse>;
  GetPlayerWinCount(
    request: GetPlayerWinCountRequest,
  ): Observable<GetPlayerWinCountResponse>;
}
