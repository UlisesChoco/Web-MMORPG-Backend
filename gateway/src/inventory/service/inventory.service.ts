...
export interface InventoryService {
  ...
  ): Observable<GetPlayerInventoryResponse>;
  GetEquippedItems(
    request: GetEquippedItemsRequest,
  ): Observable<GetEquippedItemsResponse>;
  AddItemToInventory(
    request: AddItemToInventoryRequest,
  ): Observable<AddItemToInventoryResponse>;
  RemoveItemFromInventory(
    request: RemoveItemFromInventoryRequest,
  ): Observable<RemoveItemFromInventoryResponse>;
  ...
  GetEquipmentStatBonus(
    request: GetEquipmentStatBonusRequest,
  ): Observable<GetEquipmentStatBonusResponse>;
}
