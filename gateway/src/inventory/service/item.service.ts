...
export interface ItemService {
  GetItemsByRequiredLevel(
    request: GetItemsByRequiredLevelRequest,
  ): Observable<GetItemsByRequiredLevelResponse>;
  GetItemsByRequiredLevelAndSlot(
    request: GetItemsByRequiredLevelAndSlotRequest,
  ): Observable<GetItemsByRequiredLevelAndSlotResponse>;
}
