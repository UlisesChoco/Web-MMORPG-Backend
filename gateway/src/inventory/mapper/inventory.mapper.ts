...
export class InventoryMapper {
  static toGetPlayerInventoryResponseDTO(
    data: any,
  ): GetPlayerInventoryResponseDTO {
  ...
  static toAddItemToInventoryResponseDTO(
    data: any,
  ): AddItemToInventoryResponseDTO {
  ...
  static toRemoveItemFromInventoryResponseDTO(
    data: any,
  ): RemoveItemFromInventoryResponseDTO {
  ...
  static toGetEquipmentStatBonusResponseDTO(
    data: any,
  ): GetEquipmentStatBonusResponseDTO {
