...
export class ItemMapper {
  static toGetItemsByRequiredLevelResponseDTO(
    data: any,
  ): GetItemsByRequiredLevelResponseDTO {
  ...
  static toGetItemsByRequiredLevelAndSlotResponseDTO(
    data: any,
  ): GetItemsByRequiredLevelAndSlotResponseDTO {
