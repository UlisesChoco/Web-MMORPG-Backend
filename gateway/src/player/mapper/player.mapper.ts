...
export class PlayerMapper {
  ...
  static toUpdatePlayerRequest(data: any): UpdatePlayerRequest {
    ...
    if (dto.updates.experience !== undefined)
      updates['experience'] = dto.updates.experience;
    if (dto.updates.experienceLimit !== undefined)
      updates['experienceLimit'] = dto.updates.experienceLimit;
    if (dto.updates.freeStatPoints !== undefined)
      updates['freeStatPoints'] = dto.updates.freeStatPoints;
    if (dto.updates.hpBonus !== undefined)
      updates['hpBonus'] = dto.updates.hpBonus;
    if (dto.updates.atkBonus !== undefined)
      updates['atkBonus'] = dto.updates.atkBonus;
    if (dto.updates.defBonus !== undefined)
      updates['defBonus'] = dto.updates.defBonus;
    if (dto.updates.staminaBonus !== undefined)
      updates['staminaBonus'] = dto.updates.staminaBonus;
    if (dto.updates.accuracyBonus !== undefined)
      updates['accuracyBonus'] = dto.updates.accuracyBonus;
    if (dto.updates.evasionBonus !== undefined)
      updates['evasionBonus'] = dto.updates.evasionBonus;

    const request: UpdatePlayerRequest = {
      playerId: dto.playerId as any,
      updates: updates,
    };
