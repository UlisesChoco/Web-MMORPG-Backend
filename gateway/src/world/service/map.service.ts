...
export interface MapService {
  ...
  ListMapEnemies(
    request: ListMapEnemiesRequest,
  ): Observable<ListMapEnemiesResponse>;

  GetExpandedMapEnemyPool(
    request: GetExpandedMapEnemyPoolRequest,
  ): Observable<GetExpandedMapEnemyPoolResponse>;
}
