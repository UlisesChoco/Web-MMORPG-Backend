...
export interface TowerPlayerProgressService {
  GetPlayerTowerProgress(
    request: GetPlayerTowerProgressRequest,
  ): Observable<GetPlayerTowerProgressResponse>;
  RegisterPlayerTowerProgress(
    request: RegisterPlayerTowerProgressRequest,
  ): Observable<RegisterPlayerTowerProgressResponse>;
}
