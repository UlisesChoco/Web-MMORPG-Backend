...
export class TowerPlayerProgressMapper {
  static toGetPlayerTowerProgressResponseDTO(
    data: any,
  ): GetPlayerTowerProgressResponseDTO {
  ...
  static toRegisterPlayerTowerProgressRequest(
    dto: any,
  ): RegisterPlayerTowerProgressRequest {
    const response = dto as RegisterPlayerTowerProgressRequestDTO;

    const request = {
      playerId: response.playerId as any,
      towerId: response.towerId as any,
    };
